    ...
    for ii in range(len(filenames)):
        if eyn=='n':
            ...
            if fnmatch.fnmatch(filenames[ii],'*.MTex'):
                ...
                if exlines[0].find('.')>=0:
                        ...
                        exyn=eval(input('Still convert? (y/n) as a string'))
                        if exyn=='n':
                            exfid.close()
                        else:
                ...
                if eylines[0].find('.')>=0:
                        ...
                        eyyn=eval(input('Still convert? (y/n) as a string'))
                        if eyyn=='n':
                            eyfid.close()
                        else:
        ...
        if magtype=='lp' and lpyn=='n':
            ...
            if fnmatch.fnmatch(filenames[ii],'*.BX'):
                ...
                if bxlines[0].find('.')>=0:
                    print('Found decimal point '+filenames[ii]+'. Check File.')
                    bxyn=eval(input('Still convert? (y/n) as a string'))
                    if bxyn=='n':
                            bxfid.close()
                    else:
            ...
            #convert BY
                ...
                if bylines[0].find('.')>=0:
                    print('Found decimal point '+filenames[ii]+'. Check File.')
                    byyn=eval(input('Still convert? (y/n) as a string'))
                    if byyn=='n':
                            byfid.close()
                    else:
            ...
            #convert BZ
                ...
                if bzlines[0].find('.')>=0:
                    print('Found decimal point '+filenames[ii]+'. Check File.')
                    bzyn=eval(input('Still convert? (y/n) as a string'))
                    if bzyn=='n':
                            bzfid.close()
                    else:
